...
describe SwipelyBuilder::Docker do
  ...
  describe '#make_git_archive' do
    ...
    context 'when both the name and git archive are specified' do
      ...
      it 'makes a git archive' do
        ...
        names.should include('/dev/random/swipely_builder.gemspec')
      end
    end
  end
  ...
  describe '#import_base', :docker do
    ...
    it 'works' do
      ...
      File.exist?('build/docker/swipely_builder-my-app-image.tgz').should be_true
    end
  end
  ...
  describe '#generate!', :docker do
    let(:docker_file) { 'build/docker/swipely_builder_test-generate-image.tgz' }
    ...
    context 'without cleaning up' do
      ...
      it 'builds a docker image' do
        expect {
          ...
          SwipelyBuilder::Util.is_gzip?(docker_file).should be_true
          ...
          paths.should include('./lib/swipely_builder.rb')
